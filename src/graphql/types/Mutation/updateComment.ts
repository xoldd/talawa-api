...
builder.mutationField("updateComment", (t) =>
	t.field({
		...
		resolve: async (_parent, args, ctx) => {
			...
			// Updated comment not being returned means that either it was already updated or its `id` column was changed by external entities before this update operation.
